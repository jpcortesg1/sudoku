import { setCell, subtractClue } from "@/features/configuration/sudokuSlice";
...
export default function ClueButton() {
  ...
  const { clues, currentCell, sudokuSolved, emptySudoku } = useSelector((root: RootState) => root.sudoku)
