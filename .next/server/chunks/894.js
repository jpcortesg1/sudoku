...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(4225));
...
const _staticgenerationbailout = __webpack_require__(6629);
class DraftMode {
    get isEnabled() {
...
const _requestcookies = __webpack_require__(1283);
const _headers = __webpack_require__(7396);
const _cookies = __webpack_require__(4850);
const _requestasyncstorage = __webpack_require__(9870);
const _actionasyncstorage = __webpack_require__(7878);
const _staticgenerationbailout = __webpack_require__(6629);
const _draftmode = __webpack_require__(3517);
function headers() {
...
const _headers = __webpack_require__(7396);
const _constants = __webpack_require__(6347);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(37);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(37);
...
const _apiutils = __webpack_require__(2267);
...
const _approuterheaders = __webpack_require__(8448);
const _headers = __webpack_require__(7396);
const _requestcookies = __webpack_require__(1283);
const _cookies = __webpack_require__(4850);
const _draftmodeprovider = __webpack_require__(2271);
...
const _http = __webpack_require__(1978);
const _responsehandlers = __webpack_require__(6539);
...
const _cookies = __webpack_require__(8430);
const _nexturl = __webpack_require__(5624);
const _cleanurl = __webpack_require__(3798);
...
const _notfound = __webpack_require__(3780);
const _redirect = __webpack_require__(1711);
const _responsehandlers = __webpack_require__(6539);
...
const _routemodule = __webpack_require__(7264);
const _requestasyncstoragewrapper = __webpack_require__(5875);
const _staticgenerationasyncstoragewrapper = __webpack_require__(6308);
const _responsehandlers = __webpack_require__(6539);
const _http = __webpack_require__(1978);
const _patchfetch = __webpack_require__(9941);
const _tracer = __webpack_require__(3681);
const _constants = __webpack_require__(4747);
const _getpathnamefromabsolutepath = __webpack_require__(4717);
const _proxyrequest = __webpack_require__(8131);
const _resolvehandlererror = __webpack_require__(6209);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(9762));
const _autoimplementmethods = __webpack_require__(2816);
const _getnonstaticmethods = __webpack_require__(8933);
const _requestcookies = __webpack_require__(1283);
const _routekind = __webpack_require__(1314);
const _parsedurlquerytoparams = __webpack_require__(6022);
...
const { requestAsyncStorage } = __webpack_require__(9870);
const { staticGenerationAsyncStorage } = __webpack_require__(5441);
const serverHooks = __webpack_require__(5236);
const headerHooks = __webpack_require__(5116);
const { staticGenerationBailout } = __webpack_require__(6629);
const { actionAsyncStorage } = __webpack_require__(7878);
...
const _constants = __webpack_require__(4747);
const _tracer = __webpack_require__(3681);
const _constants1 = __webpack_require__(6347);
...
const _detectdomainlocale = __webpack_require__(626);
const _formatnextpathnameinfo = __webpack_require__(9258);
const _gethostname = __webpack_require__(7505);
const _getnextpathnameinfo = __webpack_require__(1938);
...
const _detectdomainlocale = __webpack_require__(6631);
const _formatnextpathnameinfo = __webpack_require__(8767);
const _gethostname = __webpack_require__(4205);
const _getnextpathnameinfo = __webpack_require__(717);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _reflect = __webpack_require__(9682);
...
const _cookies = __webpack_require__(3495); //# sourceMappingURL=cookies.js.map
...
const _cookies = __webpack_require__(8430); //# sourceMappingURL=cookies.js.map
...
const _nexturl = __webpack_require__(5015);
const _utils = __webpack_require__(6477);
const _error = __webpack_require__(4596);
const _cookies = __webpack_require__(8193);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(3082));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(5077);
const _pathhasprefix = __webpack_require__(569);
...
const _addpathprefix = __webpack_require__(3446);
const _pathhasprefix = __webpack_require__(3180);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _parsepath = __webpack_require__(5228);
...
const _parsepath = __webpack_require__(1325);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
const _removetrailingslash = __webpack_require__(5648);
const _addpathprefix = __webpack_require__(5077);
const _addpathsuffix = __webpack_require__(8858);
const _addlocale = __webpack_require__(8784);
...
const _removetrailingslash = __webpack_require__(7661);
const _addpathprefix = __webpack_require__(3446);
const _addpathsuffix = __webpack_require__(1564);
const _addlocale = __webpack_require__(4643);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _normalizelocalepath = __webpack_require__(3804);
const _removepathprefix = __webpack_require__(1034);
const _pathhasprefix = __webpack_require__(569);
...
const _normalizelocalepath = __webpack_require__(4490);
const _removepathprefix = __webpack_require__(8612);
const _pathhasprefix = __webpack_require__(3180);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
...
const serverExports = {
    NextRequest: (__webpack_require__(8846).NextRequest),
    NextResponse: (__webpack_require__(2364)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(7357)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(4362).userAgentFromString),
    userAgent: (__webpack_require__(4362).userAgent)
};
